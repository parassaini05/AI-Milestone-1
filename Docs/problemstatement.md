...
### 1. Data Ingestion
- **Dataset**: Load and preprocess the Zomato dataset from Hugging Face ([zomato-restaurant-recommendation](https://huggingface.co/datasets/ManikaSaini/zomato-restaurant-recommendation))
- **Fields**: Extract relevant fields such as restaurant name, location, cuisine, cost, rating, etc.
